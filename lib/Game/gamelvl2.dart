...
class GameLvl2 extends StatefulWidget {
  final Map arguments;
  const GameLvl2({super.key, required this.arguments});

  @override
  State<GameLvl2> createState() => _GameLvl2State();
}

class _GameLvl2State extends State<GameLvl2> {
  late bool levelup;
  bool levelkeep = true;
  int currentlevel = 0;
