...
class TopPlayers extends StatefulWidget {
  final Map arguments;
  const TopPlayers({super.key, required this.arguments});
          ...
          Container(
              ...
              child: Container(
                  ...
                  child: Column(children: [
                    Padding(
                      padding: EdgeInsets.all(_ScreenAdapter.width * 0.1),
                      child: InkWell(
                          onTap: () {
                          ...
                          child: Expanded(
                            child: Container(
                                alignment: Alignment.center,
                                height: _ScreenAdapter.width * 0.5,
                                child: const Image(
                                    fit: BoxFit.cover,
                                    image: AssetImage(
                                        "images/game/animatedgoldtrophypic.gif"))),
                          )),
                    ),
                    Expanded(
